...
const awards = [
  { title: "Best Engineering Project Award", description: "Awarded for the final year B.E. project on automated systems.", year: "2017" },
  { title: "Excellence in Teaching", description: "Recognized as the top instructor at Trishahid Namuna Ma. Vi.", year: "2023" },
  { title: "Research Grant Recipient", description: "Secured funding for MSc thesis on spatial decision support.", year: "2025" },
];
