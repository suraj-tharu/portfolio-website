...
const defaultProjects = [
  ...
  { title: "GIS Visualization & Mapping", span: "md:col-span-7", aspect: "aspect-[4/3] md:aspect-auto md:h-[400px]", img: "https://images.unsplash.com/photo-1569163139394-de4798aa62b1?auto=format&fit=crop&w=1200&q=80", url: "#" },
